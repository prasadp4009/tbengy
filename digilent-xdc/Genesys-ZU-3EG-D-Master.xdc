...
## clk = 25MHz
set_property -dict { PACKAGE_PIN E12 IOSTANDARD LVCMOS18 } [get_ports { clk }];
...
## Buttons
set_property -dict { PACKAGE_PIN B10  IOSTANDARD LVCMOS18 } [get_ports { rst }]; #IO_L9N_AD11N_45/25 Sch=btn[2]
...
## LED
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { ledOut }]; #IO_L12P_AD0P_46/26 Sch=ld[1]
