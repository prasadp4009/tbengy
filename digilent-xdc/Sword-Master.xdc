...
## clk = 200MHz
set_property -dict { PACKAGE_PIN AD12  IOSTANDARD LVDS     } [get_ports { clk }]; #IO_L12P_T1_MRCC_33 Sch=fpga_sysclk_p
...
## LEDs
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { ledOut }]; #IO_L9P_T1_DQS_18 Sch=ld[0]
...
set_property -dict { PACKAGE_PIN AE13  IOSTANDARD LVCMOS15 } [get_ports { rst }]; #IO_L19P_T3_33 Sch=btn_c[0]
